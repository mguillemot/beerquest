...
public class I18n {
    ...
    private static const _strings:Object = {
        fr: {
            ...
            "end.wall-of-shame-button": "MUR DE LA HONTE (publier sur mon mur)",
            "end.challenge-success-explaination.1": "Tu as gagné ce round.",
            "end.challenge-success-explaination.2": "Ton pote arrivera-t-il à faire mieux ?",
            "": ""
        },
        en: {
            "capacity.none.name": "?",
